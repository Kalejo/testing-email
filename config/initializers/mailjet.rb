...
Dotenv.load('mailjet.env')# kindly generated by appropriated Rails generator

Mailjet.configure do |config|
  config.api_key = ENV["cle_public"]
  config.secret_key = ENV['cle_prive']
  config.default_from = ENV['mon_email']
